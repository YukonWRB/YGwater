...
test_that("continuous level plot is as expected for full year with numeric startDay and endDay when saved to a file", {
  ...
  dir.create(dir)
  plot <- plotOverlap("09EA004", "water level", startDay = 1, endDay = 365, years = "2022", save_path = dir,  historic_range = "last")
...
test_that("french labels work with full year", {
  plot <- plotOverlap("09EA004", "water level", startDay = 1, endDay = 365, years = "2022", save_path = NULL,  historic_range = "last", language = "fr")
...
test_that("continuous level plot is as expected for full year with numeric startDay and endDay when output to console", {
  plot <- suppressWarnings(plotOverlap("09EA004", "water level", startDay = 1, endDay = 365, years = "2022", historic_range = "last"))
...
test_that("continuous level plot is as expected for full year with character startDay and endDay", {
  plot <- plotOverlap("09EA004", "water level", startDay = "2023-01-01", endDay = "2023-12-31", years = "2022", save_path = NULL, historic_range = "last")
...
test_that("continuous flow plot is as expected for full year with numeric startDay and endDay", {
  plot <- plotOverlap("09EA004", "discharge, river/stream", startDay = 1, endDay = 365, years = "2022", save_path = NULL, historic_range = "last")
  vdiffr::expect_doppelganger("full num start/end", plot)
})

test_that("overlaping year plot throws no error when years is NULL", {
  expect_no_error(suppressWarnings(plotOverlap("09AA-M1", "water equivalent, snow", startDay = "2023-09-01", endDay = "2023-05-31", return_months = c(4,5), historic_range = "last")))
})

test_that("SWE plot works when overlaping new year, dates as character", {
  plot <- plotOverlap("09AA-M1", "water equivalent, snow", startDay = "2023-09-01", endDay = "2023-05-31", years = "2022", save_path = NULL, return_months = c(4,5), historic_range = "last")
...
test_that("french labels work with overlaping years", {
  plot <- plotOverlap("09AA-M1", "snow depth", startDay = 250, endDay = 150, years = "2022", save_path = NULL, return_months = c(4,5), historic_range = "last", language = "fr")
...
test_that("continuous level plot is as expected for multiple years when output to console", {
  plot <- suppressWarnings(plotOverlap("09EA004", "water level", startDay = 1, endDay = 365, years = c(2019,2020,2021,2022), historic_range = "last"))
...
test_that("historic range can be < requested year", {
  plot <- suppressWarnings(plotOverlap("09EA004", "water level", startDay = 1, endDay = 365, years = c(2018), historic_range = "all"))
  vdiffr::expect_doppelganger("hist range > plotted year", plot)
})
#Test for historical range and return periods able to flex.
test_that("returns can be for yrs > requested year", {
  plot <- suppressWarnings(plotOverlap("09EA004", "water level", startDay = 1, endDay = 365, years = c(2018), historic_range = "all", return_max_year = 2022))
