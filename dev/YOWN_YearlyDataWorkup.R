...
# Compares peak and trough levels for current year and historical years
con <- AquaConnect()
#PlotTimeSeries in YGwater
# Locatio table in Public schema
#Timeserires table , timesrries metadata

YOWN_YearlyAnalysis <- function()
...
if (is.na(data$qualifier[1])) {
  ...
  warning("Qualifier for timeseries ", tsid, " do not begin at start of time series. UNK added until first qualifier observed.")
}
