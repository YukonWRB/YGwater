...
db_url_prod = f"postgresql://{db_config['snowAdminUser']}:{db_config['snowAdminPass']}@{db_config['snowHost']}:{db_config['snowPort']}/aquacache"
db_url_dev = f"postgresql://{db_config['aquacacheAdminUser']}:{db_config['aquacacheAdminPass']}@{db_config['aquacacheHost']}:{db_config['aquacachePort']}/aquacache"