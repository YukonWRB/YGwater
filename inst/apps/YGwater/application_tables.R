...
# IMPORTANT2: Make 100% sure that the database schemas match ones targeted by the 'SET search_path TO...' command! If there are new schemas in the database compared to when this script was created, ensure you modify the command.
...
DBI::dbExecute(con, "CREATE TABLE IF NOT EXIST application.text (
...
DBI::dbExecute(con, "CREATE TABLE IF NOT EXIST application.images (
                id TEXT NOT NULL PRIMARY KEY,
...
DBI::dbExecute(con, "CREATE TABLE IF NOT EXIST application.page_content (
                page TEXT NOT NULL,
