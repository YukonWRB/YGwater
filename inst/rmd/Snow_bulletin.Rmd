...
snowbullpillow <- function(location, custom_title, year, number="", language="en") {
...
snowBullPrecip <- function(tsid, year, scale, custom_title, language) {
...
snowbullCDDF <- function(timeseries_id, custom_title, language="en") {
  ...
  stats_d <- plot$data[plot$data$datetime == paste0(params$year, "-0", params$month, "-01"),]
...
if (language == "french") {
  lines <- c("Valeur maximale observée", "Valeur minimale observée", "Valeur médiane observée", "Année courante", "Niveau d'inondation", "L'étendue moyenne des \nvaleurs observées", "L'étendue min - max des \nvaleurs observées")
...
Established in 2023, the Log Cabin Meteorological Station registered Snow Water Equivalent (SWE) at \-\--% of the historical median when compared with the manual snow survey record for that site (Figure A3). 
...
# Plot C 
  plot_c <- snowBullPrecip(663, params$year, params$scale, "Whitehorse", language = language)


# Plot D
  plot_d <- snowbullCDDF(timeseries_id = 484, custom_title = "Whitehorse", language = substr(params$language, 1, 2))
...
# Plot SWE
if (language=="french") {
  snowbullpillow(location = station_id, custom_title = "A1: Équivalent en eau de neige - Tagish", year = params$year, language="fr")
} else {
...
# Plot SWE
if (language=="french") {
  snowbullpillow(location = station_id, custom_title = "A2: Équivalent en eau de neige - Wolf Creek", year = params$year, language="fr")
} else {
...
snow_s <- DBI::dbGetQuery(con, paste0("SELECT target_datetime, value FROM measurements_discrete ",
  ...
  # title language
  if (language == "french") {
    custom_title <- "A3: Équivalent en eau de neige - Log Cabin (C-B)"
  } else {
...
ggplot2::ggplot() +
  ...
  ggplot2::scale_x_datetime(date_breaks = "2 months", date_labels = labs, expand = c(0,0), 
                            limits=c(as.POSIXct(paste0(params$year-1, "-09-01")), as.POSIXct(paste0(params$year, "-06-30")))) + 
...
if (params$language == "french") {
  snowbullSWE(loc= "Upper Yukon", basin = "Upper_Yukon",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin sup. du Yukon")
} else {
  snowbullSWE(loc= "Upper Yukon", basin = "Upper_Yukon",
...
# Plotting
  snowbullWater(location = station_id,
              ...
              custom_title = custom_title,
              scale = params$scale,
              language = substr(params$language, 1, 2))
...
# Plot C
plot_c <- snowBullPrecip(665, params$year, params$scale, "Teslin", language = language)
# Plot D
plot_d <- snowbullCDDF(timeseries_id = 532, custom_title = "Teslin", language = substr(params$language, 1, 2))
```
...
if (params$language == "french") {
  snowbullSWE(loc= "Teslin - Big Salmon", basin = "Teslin_Big_Salmon",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin Teslin - Big Salmon")
} else {
  snowbullSWE(loc= "Teslin - Big Salmon", basin = "Teslin_Big_Salmon",
...
# Create plot C
plot_c <- snowBullPrecip(666, params$year, params$scale, "Carmacks", language = language)
# Plot D
plot_d <- snowbullCDDF(timeseries_id = 540, custom_title = "Carmacks", language = substr(params$language, 1, 2))
```
...
if (params$language == "french") {
  snowbullSWE(loc= "Central Yukon", basin = "Central_Yukon",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin central du Yukon")
} else {
  snowbullSWE(loc= "Central Yukon", basin = "Central_Yukon",
...
# Create plot D
plot_d <- snowbullCDDF(timeseries_id = 500, custom_title = "Faro", language = substr(params$language, 1, 2))
```
...
# Plot SWE
if (language == "french") {
  snowbullpillow(location = station_id, custom_title = "A: Équivalent en eau de neige à Twin Creeks", year = params$year, language="fr")
} else {
...
if (params$language == "french") {
  snowbullSWE(loc= "Pelly", basin = "Pelly",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin Pelly")
} else {
  snowbullSWE(loc= "Pelly", basin = "Pelly",
...
# Create plot c
plot_c <- snowBullPrecip(668, params$year, params$scale, "Mayo", language = language)
# Create plot D
plot_d <- snowbullCDDF(timeseries_id = 548, custom_title = "Mayo", language = substr(params$language, 1, 2))
```
...
# Plot SWE
if (language == "french") {
  snowbullpillow(location = station_id, custom_title = "A: Équivalent en eau de neige au lac Withers", year = params$year, language="fr")
} else {
...
if (params$language == "french") {
  snowbullSWE(loc= "Stewart", basin = "Stewart",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin Stewart")
} else {
  snowbullSWE(loc= "Stewart", basin = "Stewart",
...
```{r White_basin, echo=FALSE, eval=include, fig.show='hold', fig.align='center', out.width="50%", fig.height=fig.height_half}
# B
# Plotting 
if (params$language == "french") {
  snowbullSWE(loc= "White", basin = "White",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin White")
} else {
  snowbullSWE(loc= "White", basin = "White",
...
# Create plot C
plot_c <- snowBullPrecip(664, params$year, params$scale, "Dawson", language = language)
# Create plot D
plot_d <- snowbullCDDF(timeseries_id = 492, custom_title = "Dawson", language = substr(params$language, 1, 2))
...
snow_s <- DBI::dbGetQuery(con, paste0("SELECT target_datetime, value FROM measurements_discrete ",
  ...
  # title language
  if (language == "french") {
    custom_title <- "A: Équivalent en eau de neige à King Solomon Dome"
  } else {
...
if (params$language == "french") {
  snowbullSWE(loc= "Lower Yukon", basin = "Lower_Yukon",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin inf. Yukon")
} else {
  snowbullSWE(loc= "Lower Yukon", basin = "Lower_Yukon",
...
if (params$language == "french") {
  custom_title  <- "E: Débit du fleuve Yukon à la rivière White"
} else {
...
plot_c <- snowBullPrecip(671, params$year, params$scale, "Old Crow", language = language)
# Create plot D and associated stat
plot_d <- snowbullCDDF(timeseries_id = 556, custom_title = "Old Crow", language = substr(params$language, 1, 2))
...
if (params$language == "french") {
  snowbullSWE(loc= "Porcupine", basin = "Porcupine",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin Porcupine")
} else {
  snowbullSWE(loc= "Porcupine", basin = "Porcupine",
...
if (params$language == "french") {
  snowbullSWE(loc= "Peel", basin = "Peel",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin Peel")
} else {
  snowbullSWE(loc= "Peel", basin = "Peel",
...
# Create plot C and associated stat
plot_c <- snowBullPrecip(667, params$year, params$scale, "Watson Lake", language = language)
# Create plot D and associated stat
plot_d <- snowbullCDDF(timeseries_id = 508, custom_title = "Watson Lake", language = substr(params$language, 1, 2))
```
...
# Plot SWE
if (language == "french") {
  snowbullpillow(location = station_id, custom_title = "A: Équivalent en eau de neige à la rivière Hyland", year = params$year, language="fr")
} else {
...
if (params$language == "french") {
  snowbullSWE(loc= "Liard", basin = "Liard",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin Liard")
} else {
  snowbullSWE(loc= "Liard", basin = "Liard",
...
if (params$language == "french") {
  snowbullSWE(loc= "Alsek", basin = "Alsek",
            year = params$year, swe_basins = swe_basins, custom_title = "B: Relevés nivométriques - bassin Alsek")
} else {
  snowbullSWE(loc= "Alsek", basin = "Alsek",
