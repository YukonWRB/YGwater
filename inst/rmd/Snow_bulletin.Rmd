...
textColour <- function(desc) {
  ...
  } else if (desc == "" || grepl("close to|près de|très près de", desc)) {
    text_colour <- officer::fp_text_lite(color = "#7A9A01", bold = TRUE, font.size = 11)
...
-   **Figure A:** Daily Snow Water Equivalent (SWE) data starting in September at one specific location in the watershed, showing an overview of winter snowpack evolution.
-   **Figure B:** Current, basin-averaged estimated Snow Water Equivalent (SWE) from snow survey data, compared with historical data, serving as an indicator of potential runoff volumes in the spring (acknowledging that snow sublimation, evapotranspiration, rain and glacier melt also significantly affect runoff).
...
`r officer::ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Upper_Yukon",]$description, if (language == "english") "average" else " moyenne"), textColour(stats$basin_stats[stats$basin_stats$basin=="Upper_Yukon",]$description))`.
`r if (language == "english") {
...
`r officer::ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==48168 & stats$precip_stats$period == precip_period, "description"], if (language == "english")  "normal" else "normales"), textColour(stats$precip_stats[stats$precip_stats$location_id==48168 & stats$precip_stats$period==precip_period, "description"]))` 
`r if (language == "english") {
...
`r if (language == "english") "The measured water surface elevation (relative to sea level) in Marsh Lake is currently" else "Le niveau d'eau (par rapport au niveau de la mer) du lac Marsh est actuellement"`
`r officer::ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09AB004",]$description, if (language == "english") "average" else " moyenne"), textColour(stats$flow_stats[stats$flow_stats$location_id=="09AB004",]$description))`
`r if (language == "english") {
...
`r officer::ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09AB010",]$description, if (language == "english") "average" else " moyenne"), textColour(stats$flow_stats[stats$flow_stats$location_id=="09AB010",]$description))`
`r if( language == "english") {
...
`r officer::ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Teslin_Big_Salmon",]$description, if (language == "english") "average" else " moyenne"), textColour(stats$basin_stats[stats$basin_stats$basin=="Teslin_Big_Salmon",]$description))`.
`r if (language == "english") {
...
`r officer::ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==8985 & stats$precip_stats$period==precip_period,]$description, if (language == "english")  "normal" else "normales"), textColour(stats$precip_stats[stats$precip_stats$location_id==8985 & stats$precip_stats$period==precip_period,]$description))` 
`r if (language == "english") {
...
(Figure E). 
Teslin Lake typically peaks in late June and is predominantly snowmelt driven. The \-\-\-\-- snowpack and \-\-\-\-- water level suggest that summer water levels will be \-\-\-\--. Peak water levels will depend on spring weather patterns.
...
**mm** as of `r month_names[params$month]` 1
(Figure B).
...
`r officer::ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==27950 & stats$precip_stats$period==precip_period,]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==27950 & stats$precip_stats$period==precip_period,]$description))` from October through `r month_names[params$month-1]`
...
of historical median on `r month_names[params$month]` 1. Cumulative
...
**`r stats$cddf_stats[stats$cddf_stats$location_id==27950 & stats$cddf_stats$period==cddf_period,]$value`\u00B0C-Days**
on `r month_names[params$month]` 1
(Figure D), which suggests `r iceThickness(stats$cddf_stats[stats$cddf_stats$location_id==27950 & stats$cddf_stats$period==cddf_period,]$perc_hist_med) `
...
of the historical median (Figure A). The
...
as of `r month_names[params$month]` 1
(Figure B).
...
of historical median, with
**`r stats$cddf_stats[stats$cddf_stats$location_id==8964 & stats$cddf_stats$period==cddf_period,]$value`\u00B0C-Days**
on `r month_names[params$month]` 1
(Figure D), which suggests `r iceThickness(stats$cddf_stats[stats$cddf_stats$location_id==8964 & stats$cddf_stats$period==cddf_period,]$perc_hist_med) ` on rivers and lakes of the region.
...
of the historical median (Figure A). The Stewart River basin-averaged SWE is estimated to be
...
`r officer::ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==51426 & stats$precip_stats$period==precip_period,]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==51426 & stats$precip_stats$period==precip_period,]$description))` from October through `r month_names[params$month-1]`
(Figure C). Cumulative winter
precipitation was
...
of historical median, with
**`r stats$cddf_stats[stats$cddf_stats$location_id==51426 & stats$cddf_stats$period==cddf_period,]$value`\u00B0C-Days**
on `r month_names[params$month]` 1
(Figure D), which suggests `r iceThickness(stats$cddf_stats[stats$cddf_stats$location_id==51426 & stats$cddf_stats$period==cddf_period,]$perc_hist_med) ` on rivers and lakes of the region.
...
record for that site (Figure A). The
...
`r officer::ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==10194 & stats$precip_stats$period==precip_period,]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==10194 & stats$precip_stats$period==precip_period,]$description))` from October through `r month_names[params$month-1]`
(Figure C). Cumulative winter
precipitation was
...
of historical median, with
**`r stats$cddf_stats[stats$cddf_stats$location_id==10194 & stats$cddf_stats$period==cddf_period,]$value`\u00B0C-Days**
on `r month_names[params$month]` 1
(Figure D), which suggests `r iceThickness(stats$cddf_stats[stats$cddf_stats$location_id==10194 & stats$cddf_stats$period==cddf_period,]$perc_hist_med) ` on rivers and lakes of the region.
...
`r officer::ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==26894 & stats$precip_stats$period==precip_period,]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==26894 & stats$precip_stats$period==precip_period,]$description))` from October through `r month_names[params$month-1]`
(Figure C). Cumulative winter
precipitation was
...
of historical median, with
**`r stats$cddf_stats[stats$cddf_stats$location_id==26894 & stats$cddf_stats$period==cddf_period,]$value`\u00B0C-Days**
on `r month_names[params$month]` 1
(Figure D), which suggests `r iceThickness(stats$cddf_stats[stats$cddf_stats$location_id==26894 & stats$cddf_stats$period==cddf_period,]$perc_hist_med) ` on rivers and lakes of the region.
...
`r officer::ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==32293 & stats$precip_stats$period==precip_period,]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==32293 & stats$precip_stats$period==precip_period,]$description))` from October through `r month_names[params$month-1]`
(Figure C). Cumulative winter
precipitation was
...
of historical median, with
**`r stats$cddf_stats[stats$cddf_stats$location_id==32293 & stats$cddf_stats$period==cddf_period,]$value`\u00B0C-Days**
on `r month_names[params$month]` 1
(Figure D), which suggests `r iceThickness(stats$cddf_stats[stats$cddf_stats$location_id==32293 & stats$cddf_stats$period==cddf_period,]$perc_hist_med) ` on rivers and lakes of the region.
...
(Figure E). High flows in this watershed
...
* Composite record. Current location measurements combined with historical record from discontinued nearby location, adjusted based on overlapping years of record.
...
* Enregistrement composite. Les mesures actuelles de l'emplacement sont combinées avec l'enregistrement historique de l'emplacement voisin abandonné, ajusté en fonction des années d'enregistrement chevauchantes.
