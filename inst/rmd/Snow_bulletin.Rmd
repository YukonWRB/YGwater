...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "Upper Yukon", basin = "Upper_Yukon",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin sup. du Yukon", language = language_param)
  } else {
    snowbullSWE(loc = "Upper Yukon", basin = "Upper_Yukon",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Upper Yukon Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "Teslin - Big Salmon", basin = "Teslin_Big_Salmon",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin Teslin / Big Salmon", language = language_param)
  } else {
    snowbullSWE(loc = "Teslin - Big Salmon", basin = "Teslin_Big_Salmon",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Teslin / Big Salmon Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "Central Yukon", basin = "Central_Yukon",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin central du Yukon", language = language_param)
  } else {
    snowbullSWE(loc = "Central Yukon", basin = "Central_Yukon",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Central Yukon Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "Pelly", basin = "Pelly",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin Pelly", language = language_param)
  } else {
    snowbullSWE(loc = "Pelly", basin = "Pelly",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Pelly Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "Stewart", basin = "Stewart",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin Stewart", language = language_param)
  } else {
    snowbullSWE(loc = "Stewart", basin = "Stewart",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Stewart Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
  cat("Plotting error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "White", basin = "White",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin White", language = language_param)
  } else {
    snowbullSWE(loc = "White", basin = "White",
                year = year_param, swe_basins = swe_basins, custom_title = "B: White Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "Lower Yukon", basin = "Lower_Yukon",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin inf. Yukon", language = language_param)
  } else {
    snowbullSWE(loc = "Lower Yukon", basin = "Lower_Yukon",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Lower Yukon Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
  cat("Plotting error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "Porcupine", basin = "Porcupine",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin Porcupine", language = language_param)
  } else {
    snowbullSWE(loc = "Porcupine", basin = "Porcupine",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Porcupine Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "Peel", basin = "Peel",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin Peel", language = language_param)
  } else {
    snowbullSWE(loc = "Peel", basin = "Peel",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Peel Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "Liard", basin = "Liard",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin Liard", language = language_param)
  } else {
    snowbullSWE(loc = "Liard", basin = "Liard",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Liard Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    snowbullSWE(loc = "Alsek", basin = "Alsek",
                year = year_param, swe_basins = swe_basins, custom_title = "B : Équivalent en eau de la neige - bassin Alsek", language = language_param)
  } else {
    snowbullSWE(loc = "Alsek", basin = "Alsek",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Alsek Basin Snow Water Equivalent", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
