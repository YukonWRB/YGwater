...
snow_s <- DBI::dbGetQuery(con, paste0("SELECT target_datetime, value FROM measurements_discrete ",
  ...
  snow_s$fake_date <- as.Date(paste0(2024, "-", format(snow_s$target_datetime, "%m-%d"))) #params$year
