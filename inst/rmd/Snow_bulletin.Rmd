...
`r officer::ftext(paste0(if (nchar(stats$flow_stats[stats$flow_stats$location_id=="09CD001",]$description) > 0) paste0(stats$flow_stats[stats$flow_stats$location_id=="09CD001",]$description, " "),
...
`r officer::ftext(if (nchar(paste0(stats$basin_stats[stats$basin_stats$basin=="Liard",]$description) > 0 ) paste0(stats$basin_stats[stats$basin_stats$basin=="Liard",]$description, " "),
