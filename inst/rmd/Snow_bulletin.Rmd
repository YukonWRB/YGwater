...
snowbullSWE <- function(loc, basin, year, swe_basins, custom_title, scale=scale_param, language) {
  ...
  # Plot
  plot <- hydrometDiscrete(location = loc, parameter = "SWE", startDay = 1, tzone = "MST", years = year, title = TRUE, custom_title = custom_title, plot_type = "linedbox", save_path = NULL, discrete_data = swe_basin, con = con, plot_scale = scale, lang = if (language == "french") "fr" else "en")
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "Upper Yukon", basin = "Upper_Yukon",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Upper Yukon Basin Snow Course", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "Teslin - Big Salmon", basin = "Teslin_Big_Salmon",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Teslin / Big Salmon Basin Snow Course", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "Central Yukon", basin = "Central_Yukon",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Central Yukon Basin Snow Course", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "Pelly", basin = "Pelly",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Pelly Basin Snow Course", language = language_param)
  }
}, error = function(e) {
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "Stewart", basin = "Stewart",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Stewart Basin Snow Course", language = language_param)
  }
}, error = function(e) {
  cat("Plotting error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "White", basin = "White",
                year = year_param, swe_basins = swe_basins, custom_title = "B: White Basin Snow Course", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "Lower Yukon", basin = "Lower_Yukon",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Lower Yukon Basin Snow Course", language = language_param)
  }
}, error = function(e) {
  cat("Plotting error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "Porcupine", basin = "Porcupine",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Porcupine Basin Snow Course", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "Peel", basin = "Peel",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Peel Basin Snow Course", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "Liard", basin = "Liard",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Liard Basin Snow Course", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
...
tryCatch({
  if (language_param == "french") {
    ...
    snowbullSWE(loc = "Alsek", basin = "Alsek",
                year = year_param, swe_basins = swe_basins, custom_title = "B: Alsek Basin Snow Course", language = language_param)
  }
}, error = function(e) {
  cat("Plot generation error: ", e$message, "\n")
})
