...
paste0("Au 1^er^ ", month_names[params$month], " l'EEN moyen du bassin est estimé à **", stats$basin_stats[stats$basin_stats$basin=='Central_Yukon',]$perc_hist_med, " %** de la médiane historique, soit **", stats$basin_stats[stats$basin_stats$basin=='Central_Yukon',]$swe, " (figure B).")
}
