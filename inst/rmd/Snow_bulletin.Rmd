...
# snowBulletin(year = 2023, month = 4, scale = 0.9, basins = c("Upper Yukon", "Teslin", "Central Yukon", "Pelly", "Stewart", "White", "Lower Yukon", "Porcupine", "Peel", "Liard", "Alsek"), save_path = "C:/Users/estewart/Documents/R/Projects/YGwater")
...
```{r UpperYukonRiver_Snow, echo=FALSE, eval=FALSE, fig.show='hold', fig.align='center', out.width="50%"}
...
```{r UpperYukon_basin, echo=FALSE, eval=FALSE, out.width="50%", fig.align='center'}
# B
# Plotting 
...
plot <- YGwater::hydrometDiscrete(location = "48168", parameter = "mly tot precip", startDay = 275, endDay = 120, tzone = "MST", 
                                  years = 2023,#c(params$year), 
                                  title = TRUE, custom_title = "C: Whitehorse Monthly Precipitation", 
                                  plot_type = "linedbox", plot_scale = 1,#params$scale, 
                                  save_path = NULL, discrete_data = test, con = con)
...
```{r MarshLake, echo=FALSE, eval=FALSE, fig.align='center', fig.width=9, fig.height=3.6}
# E1
# Set station ID
station_id <- "09AB004"
# Plotting
...
```{r LakeLaberge, echo=FALSE, eval=FALSE, fig.align='center', fig.width=9, fig.height=3.6}
# E2
# Set station ID
station_id <- "09AB010"
# Plotting
...
```{r Teslin_CDDF, echo=FALSE, eval=include, fig.show='hold', fig.align='center', out.width="50%"}
# D
