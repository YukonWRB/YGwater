...
- Certains passages utilisant du texte ajusté automatiquement (habituellement en couleure) peuvent requérir un ajustement pour le féminin et/ou le pluriel.
...
- Hyland River B combines records from the old Hyland River snow course located near the Hyland River air strip with new measurements taken 6 kilometers to the north of the old station. ", twin_correction_pts, " overlapping data points were used to adjust the historical station data (1976", knitr::asis_output("\U2011"), "2017) to the new location with correction factors of ", round(hyland_corrections[1], 2), " and ", round(hyland_corrections[2], 2), " applied to the historical SWE and depth data, respectively.
")
} else {
paste0("
...
C - Données historiques composite. Les relevés à la station sont combinée avec les données historique de la station voisine abandonnée, ajustées en fonction des années avec relevés concomitants.
