...
snowbullpillow2 <- function(location_pil, location_surv, custom_title, language=language_param, year=year_param, scale=scale_param) {
...
At Tagish Meteorological Station, Snow Water Equivalent (SWE) is estimated to be **`r pillow_stats[pillow_stats$location=='09AA-M1',]$perc`%** of the historical median (Figure`r knitr::asis_output("\U00A0")`A1), 
while at Wolf Creek Subalpine Meteorological Station, SWE is estimated to be **`r pillow_stats[pillow_stats$location=='29AB-M3',]$perc`%** of the historical median (Figure`r knitr::asis_output("\U00A0")`A2). 
Established in 2023, Log Cabin Meteorological Station registered Snow Water Equivalent (SWE) at \-\--% of the historical median when compared with the manual snow survey record for that site (Figure`r knitr::asis_output("\U00A0")`A3). 
The Upper Yukon basin-averaged SWE is estimated to be **`r basins_stats[basins_stats$basin=='Upper_Yukon',]$swe_relative * 100`%** of the historical median, with **`r basins_stats[basins_stats$basin=='Upper_Yukon',]$swe`** **mm** as of `r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`B).
...
## A3: Log Cabin
if (language_param == "french") {
  snowbullpillow2(location_pil=649, location_surv=217, custom_title="A2 : Équivalent en eau de la neige - Log Cabin (C-B)" , year=year_param, scale=scale_param)
} else {
  snowbullpillow2(location_pil=649, location_surv=217, custom_title="A2: Log Cabin (B.C) Snow Water Equivalent" , year=year_param, scale=scale_param)
}
...
Whitehorse precipitation has been ----- median since October... (Figure`r knitr::asis_output("\U00A0")`C). 
...
`r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`D), 
...
Lake is currently \-\-\-\-- average (Figure`r knitr::asis_output("\U00A0")`E1). The current snow and
...
the historic maximum for this time of year (Figure`r knitr::asis_output("\U00A0")`E2). Lake Laberge
...
**mm** as of `r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`B).
...
Teslin precipitation has been \-\-\-\-- median since October... (Figure`r knitr::asis_output("\U00A0")`C). 
Cumulative winter precipitation was **`r plot_c[[2]]`%** of historical median on `r month.name[params$month]` 1.
Cumulative degree-days of freezing (CDDF) are **`r plot_d[[2]][1]`%** of historical median, with **`r plot_d[[2]][2]`$^\circ$C-Days** on
`r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`D).
...
Lake is currently \-\-\-\-- average (Figure`r knitr::asis_output("\U00A0")`E). The \-\-\-\-- snowpack
...
of `r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`B).
...
Carmacks precipitation has been \-\-\-\-- median since October... (Figure`r knitr::asis_output("\U00A0")`C). 
Cumulative winter precipitation was **`r plot_c[[2]]`%** of historical median on `r month.name[params$month]` 1. 
Cumulative degree-days of freezing (CDDF) are **`r plot_d[[2]][1]`%** of historical median, with **`r plot_d[[2]][2]`$^\circ$C-Days** on
`r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`D).
...
average (Figure`r knitr::asis_output("\U00A0")`E). The \-\-\-\-- average snowpack combined with
...
historical median (Figure`r knitr::asis_output("\U00A0")`A). The Pelly River basin-averaged SWE is
estimated to be
**`r basins_stats[basins_stats$basin=='Pelly',]$swe_relative * 100`%**
of the historical median, with
**`r basins_stats[basins_stats$basin=='Pelly',]$swe`** **mm** as of
`r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`B).
...
\-\-\-\-- average (Figure`r knitr::asis_output("\U00A0")`E). The \-\-\-\-- average snowpack combined
...
historical median (Figure`r knitr::asis_output("\U00A0")`A). The The Stewart River basin-averaged SWE
is estimated to be
...
Mayo precipitation has been \-\-\-\-- median since October...(Figure`r knitr::asis_output("\U00A0")`C).
Cumulative winter precipitation was **`r plot_c[[2]]`%** of historical median on `r month.name[params$month]` 1. 
Cumulative degree-days of freezing (CDDF) are **`r plot_d[[2]][1]`%** of historical median, with **`r plot_d[[2]][2]`$^\circ$C-Days** on
`r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`D), 
which suggests \-\-\-\- than normal ice cover on rivers and lakes of the region.
...
\-\-\-\-- average (Figure`r knitr::asis_output("\U00A0")`E1). In this watershed, high flows are
...
with the manual snow survey record for that site (Figure`r knitr::asis_output("\U00A0")`A). The Lower
...
Precipitation at Dawson Airport has been \-\-\-\- median since October... (Figure`r knitr::asis_output("\U00A0")`C). 
Cumulative winter precipitation was **`r plot_c[[2]]`%** of historical median on `r month.name[params$month]` 1. 
Cumulative degree-days of freezing (CDDF) are **`r plot_d[[2]][1]`%** of historical median, with **`r plot_d[[2]][2]`$^\circ$C-Days** on
`r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`D), 
which suggests \-\-\-\- than normal ice cover on rivers and lakes of the region.
...
(Figure`r knitr::asis_output("\U00A0")`E). The \-\-\-\-- average snowpack combined with \-\-\-\--
...
Precipitation at Old Crow Airport has been \-\-\-\-- median since October... (Figure`r knitr::asis_output("\U00A0")`C). 
Cumulative winter precipitation was **`r plot_c[[2]]`%** of historical median on `r month.name[params$month]` 1. 
Cumulative degree-days of freezing (CDDF) are **`r plot_d[[2]][1]`%** of historical median, with **`r plot_d[[2]][2]`$^\circ$C-Days** on
`r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`D), 
which suggests \-\-\-\- than normal ice cover on rivers and lakes of the region.
...
The estimated Porcupine River discharge is \-\-\-\-- average (Figure`r knitr::asis_output("\U00A0")`E).
...
The estimated Peel River discharge is \-\-\-\-- average (Figure`r knitr::asis_output("\U00A0")`E). The
...
historical median (Figure`r knitr::asis_output("\U00A0")`A). The Liard River basin-averaged SWE is
estimated to be
...
Precipitation at Watson Lake Airport has been \-\-\-\-- median since October... (Figure`r knitr::asis_output("\U00A0")`C).
Cumulative winter precipitation was **`r plot_c[[2]]`%** of historical median on `r month.name[params$month]` 1.
Cumulative degree-days of freezing (CDDF) are **`r plot_d[[2]][1]`%** of historical median, with **`r plot_d[[2]][2]`$^\circ$C-Days** on
`r month.name[params$month]` 1 (Figure`r knitr::asis_output("\U00A0")`D).
...
(Figure`r knitr::asis_output("\U00A0")`E). The \-\-\-\-- average snowpack in the watershed combined
...
(Figure`r knitr::asis_output("\U00A0")`E). High flows in this watershed are dominated by mountain
