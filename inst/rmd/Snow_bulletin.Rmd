...
YGwater::hydrometDiscrete(location = "48168", parameter = "mly tot precip", startDay = "2023-09-01", tzone = "MST", years = c(2023), title = TRUE, custom_title = "Whitehorse precip", plot_type = "linedbox", plot_scale = 1, save_path = NULL, discrete_data = test, con = con)
``` 
