...
`r if (language == "english") "(Figure E1) while the estimated Klondike River discharge above Bonanza Creek is currently" else "(figure E1) alors que le débit de la rivière Klondike en amont du ruisseau Bonanza est"`
