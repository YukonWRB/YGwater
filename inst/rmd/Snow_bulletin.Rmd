...
snowbullSWE <- function(loc, basin, year, swe_basins) {
  ...
  # Plot
  hydrometDiscrete(location = loc, parameter = "SWE", startDay = 1, tzone = "MST", years = c(year), title = FALSE, plot_type = "linedbox", plot_scale = 1, save_path = NULL, discrete_data = swe_basin, con = hydrometConnect(silent=TRUE))
}
