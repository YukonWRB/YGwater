...
#               custom_title = "E",
#               scale = 0.9)
#dev.new(width=4, height=10, unit="cm")
...
# Test 1
 plot <- ggplot2::ggplot() +
  ...
  #ggplot2::labs(title = "Figure Legend") +  # Set legend title
  ...
  ggplot2::scale_size_manual(name = "Legend", values = c(1.5, 1.5, 1.5, 1.5, 1, 8, 8), labels = lines) +  # Customize legend entries for fill
 ...
 ggplot2::ggsave("test_plot.png", plot=plot, width=3.1, height=5)
...
```{r UpperYukonRiver_Snow, echo=FALSE, eval=include, fig.show='hold', fig.align='center', out.width="50%", fig.height=3.5}
...
```{r UpperYukon_basin, echo=FALSE, eval=include, out.width="50%", fig.align='center', fig.height=3.5}
# B
# Plotting 
...
```{r MarshLake, echo=FALSE, eval=include, fig.align='center', fig.width=9, fig.height=3.1}
# E1
# Set station ID
station_id <- "09AB004"
# Plotting
...
```{r LakeLaberge, echo=FALSE, eval=include, fig.align='center', fig.width=9, fig.height=3.1}
# E2
# Set station ID
station_id <- "09AB010"
# Plotting
...
ggplot2::ggplot() +
  ...
  ggplot2::theme(axis.title.y = ggplot2::element_text(size = 11*plot_scale), axis.text.x = ggplot2::element_text(size = 9*plot_scale), axis.text.y = ggplot2::element_text(size = 9*plot_scale), plot.title=ggplot2::element_text(hjust=0.05, size=12*plot_scale)) +
