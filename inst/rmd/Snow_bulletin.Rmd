...
#rmarkdown::render("C:/Users/estewart/Documents/R/Projects/YGwater/inst/rmd/Snow_bulletin.Rmd", params = list(year=2023, basins=c("Upper Yukon", "Teslin", "Central Yukon", "Pelly", "Stewart", "White", "Lower Yukon", "Porcupine", "Pell", "Liard", "Alsek")))
...
for (y in first_yr:last_yr) {
  ...
  # Only calculate if missing less than 10 days, but only for years that are not in the 'years' list
    if (sum(!is.na(tab$value)) >= 276 | format(min(tab$datetime), "%Y") %in% year) {
      cddf_y <- calcCDDF(tab)
...
snowbullSWE(loc= "Upper Yukon", basin = "Upper_Yukon",
            year = year+1, swe_basins = swe_basins, custom_title = "Upper Yukon Basin Monthly Snow Course Data")
``` 
...
YGwater::hydrometContinuous(parameter= "CDDF", years = c(year), title = TRUE, custom_title = "Whitehorse CDDF", returns = "none", allowed_missing = 10, plot_scale = 1, save_path = NULL, con = con, cddf_data = whitehorse)
...
snowbullSWE(loc= "Teslin - Big Salmon", basin = "Teslin_Big_Salmon",
            year = year+1, swe_basins = swe_basins, custom_title = "Teslin - Big Salmon Basin Monthly Snow Course Data")
``` 
...
YGwater::hydrometContinuous(parameter= "CDDF", years = c(year), title = TRUE, custom_title = "Teslin CDDF", returns = "none", allowed_missing = 10, plot_scale = 1, save_path = NULL, con = con, cddf_data = teslin)
...
snowbullSWE(loc= "Central Yukon", basin = "Central_Yukon",
            year = year+1, swe_basins = swe_basins, custom_title = "Central Yukon Basin Monthly Snow Course Data")
``` 
...
YGwater::hydrometContinuous(parameter= "CDDF", years = c(year), title = TRUE, custom_title = "Carmacks CDDF", returns = "none", allowed_missing = 10, plot_scale = 1, save_path = NULL, con = con, cddf_data = carmacks)
...
snowbullSWE(loc= "Pelly", basin = "Pelly",
            year = year+1, swe_basins = swe_basins, custom_title = "Pelly Basin Monthly Snow Course Data")
``` 
...
YGwater::hydrometContinuous(parameter= "CDDF", years = c(year), title = TRUE, custom_title = "Faro CDDF", returns = "none", allowed_missing = 10, plot_scale = 1, save_path = NULL, con = con, cddf_data = faro)
...
snowbullSWE(loc= "Stewart", basin = "Stewart",
            year = year+1, swe_basins = swe_basins, custom_title = "Stewart Basin Monthly Snow Course Data")
``` 
...
YGwater::hydrometContinuous(parameter= "CDDF", years = c(year), title = TRUE, custom_title = "Mayo CDDF", returns = "none", allowed_missing = 10, plot_scale = 1, save_path = NULL, con = con, cddf_data = mayo)
...
snowbullSWE(loc= "White", basin = "White",
            year = year+1, swe_basins = swe_basins, custom_title = "White Basin Monthly Snow Course Data")
``` 
...
snowbullSWE(loc= "Lower Yukon", basin = "Lower_Yukon",
            year = year+1, swe_basins = swe_basins, custom_title = "Lower Yukon Basin Monthly Snow Course Data")
``` 
...
YGwater::hydrometContinuous(parameter= "CDDF", years = c(year), title = TRUE, custom_title = "Dawson CDDF", returns = "none", allowed_missing = 10, plot_scale = 1, save_path = NULL, con = con, cddf_data = dawson)
...
snowbullSWE(loc= "Porcupine", basin = "Porcupine",
            year = year+1, swe_basins = swe_basins, custom_title = "Porcupine Basin Monthly Snow Course Data")
``` 
...
YGwater::hydrometContinuous(parameter= "CDDF", years = c(year), title = TRUE, custom_title = "Old Crow CDDF", returns = "none", allowed_missing = 10, plot_scale = 1, save_path = NULL, con = con, cddf_data = oldcrow)
...
snowbullSWE(loc= "Peel", basin = "Peel",
            year = year+1, swe_basins = swe_basins, custom_title = "Peel Basin Monthly Snow Course Data")
``` 
...
snowbullSWE(loc= "Liard", basin = "Liard",
            year = year+1, swe_basins = swe_basins, custom_title = "Liard Basin Monthly Snow Course Data")
``` 
...
YGwater::hydrometContinuous(parameter= "CDDF", years = c(year), title = TRUE, custom_title = "Watson Lake CDDF", returns = "none", allowed_missing = 10, plot_scale = 1, save_path = NULL, con = con, cddf_data = watsonlake)
...
snowbullSWE(loc= "Alsek", basin = "Alsek",
            year = year+1, swe_basins = swe_basins, custom_title = "Alsek Basin Monthly Snow Course Data")
``` 
