...
YGwater::hydrometDiscrete(location = "48168", parameter = "mly tot precip", startDay = "2023-09-01", tzone = "MST", years = c(year), title = TRUE, custom_title = "Whitehorse precip", plot_type = "linedbox", plot_scale = 1, save_path = NULL, discrete_data = test, con = con)
``` 
...
tabl <- SWE_station(year=2023, month=month, return_missing = TRUE, active = TRUE, source="hydromet")
