...
# `r officer::ftext("Map 1. Temperature Anomalies", fp_text_lite(color = "white", font.size=1))`
# `r officer::ftext("Map 2. Precipitation", fp_text_lite(color = "white", font.size=1))` 
# `r officer::ftext("Map 3. Snow Water Equivalent", fp_text_lite(color = "white", font.size=1))` 
...
# `r officer::ftext("Map 4. Location of Water Resources Snow Courses", fp_text_lite(color = "white", font.size=1))` 
