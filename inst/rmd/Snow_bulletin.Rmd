...
textColour <- function(desc) {
  if (length(desc) == 0) {
    text_colour <- fp_text_lite(color = "black", bold = TRUE, font.size=11)
  } else if (desc %in% c("slightly above", "above", "well above")) {
    text_colour <- fp_text_lite(color = "#0097A9", bold = TRUE, font.size=11)
  } else if (desc %in% c("close to")) {
    text_colour <- fp_text_lite(color = "#7A9A01", bold = TRUE, font.size=11)
  } else if (desc %in% c("slightly below", "below", "well below")) {
    text_colour <- fp_text_lite(color = "#834333", bold = TRUE, font.size=11)
  }
  return(text_colour)
}
...
snowbullpillow2 <- function(location_pil, location_surv, custom_title, language=language_param, year=year_param, scale=scale_param, month=month_param) {
...
snowbullCDDF <- function(timeseries_id, custom_title, language="en", 
  ...
  location <- DBI::dbGetQuery(con, paste0("SELECT datetime, value 
...
# Get stats for text
  stats <- snowBulletinStats(year=year_param, month=month_param, excel_output=FALSE)
  stats <<- stats
...
percent of historical median for each station, as well as the basin
averaged estimated SWE for 11 watersheds (or river basins). Where
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Upper_Yukon",]$description,
...
Established in 2023, Log Cabin Meteorological Station registered Snow
Water Equivalent (SWE) at
...
`r ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==48168 & stats$precip_stats$period=='All years',]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==48168 & stats$precip_stats$period=='All years',]$description))` from October through `r month.name[params$month-1]`
(Figure`r knitr::asis_output("\U00A0")`C). Cumulative winter
precipitation was
**`r stats$precip_stats[stats$precip_stats$location_id==48168 & stats$precip_stats$period=='All years',]$perc_hist_med`%**
...
(Figure`r knitr::asis_output("\U00A0")`D), which suggests `r iceThickness(stats$cddf_stats[stats$cddf_stats$location_id==48168 & stats$cddf_stats$period=='All years',]$perc_hist_med) ` on rivers and lakes of the region.
...
Lake is currently 
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09AB004",]$description,
...
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09AB010",]$description,
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Teslin_Big_Salmon",]$description,
" average"), textColour(stats$basin_stats[stats$basin_stats$basin=="Teslin_Big_Salmon",]$description))`.
The basin-averaged SWE is estimated at
...
`r ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==8985 & stats$precip_stats$period=='All years',]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==8985 & stats$precip_stats$period=='All years',]$description))` from October through `r month.name[params$month-1]`
(Figure`r knitr::asis_output("\U00A0")`C). Cumulative winter
precipitation was
**`r stats$precip_stats[stats$precip_stats$location_id==8985 & stats$precip_stats$period=='All years',]$perc_hist_med`%**
of historical median on `r month.name[params$month]` 1. Cumulative
degree-days of freezing (CDDF) are
...
on `r month.name[params$month]` 1
(Figure`r knitr::asis_output("\U00A0")`D), which suggests ----- than normal ice cover
...
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09AE002",]$description,
...
\-\-\-\--. Weather conditions in March and April will determine the most probable spring scenario.
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Central_Yukon",]$description,
" average"), textColour(stats$basin_stats[stats$basin_stats$basin=="Central_Yukon",]$description))`.
The basin-averaged SWE is estimated to be
...
`r ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==27950 & stats$precip_stats$period=='All years',]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==27950 & stats$precip_stats$period=='All years',]$description))` from October through `r month.name[params$month-1]`
(Figure`r knitr::asis_output("\U00A0")`C). Cumulative winter
precipitation was
**`r stats$precip_stats[stats$precip_stats$location_id==27950 & stats$precip_stats$period=='All years',]$perc_hist_med`%**
of historical median on `r month.name[params$month]` 1. Cumulative
degree-days of freezing (CDDF) are
...
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09AH004",]$description,
...
snowpack combined with \-\-\-\-- winter flows in the watershed suggests
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Pelly",]$description,
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=='Pelly',]$description, " climate normals"), textColour(stats$basin_stats[stats$basin_stats$basin=='Pelly',]$description))`. Cumulative degree-days of freezing (CDDF) are
...
on `r month.name[params$month]` 1
(Figure`r knitr::asis_output("\U00A0")`D), which suggests \-\-\-- than
normal ice cover on rivers and lakes of the region.
...
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09BC001",]$description,
" average"), textColour(stats$flow_stats[stats$flow_stats$location_id=="09BC001",]$description))`
(Figure`r knitr::asis_output("\U00A0")`E). The
\-\-\-\-- average snowpack combined with \-\-\-\-- winter flows in the
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Stewart",]$description,
...
of the historical median (Figure`r knitr::asis_output("\U00A0")`A). The
The Stewart River basin-averaged SWE is estimated to be
...
`r ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==51426 & stats$precip_stats$period=='All years',]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==51426 & stats$precip_stats$period=='All years',]$description))` from October through `r month.name[params$month-1]`
(Figure`r knitr::asis_output("\U00A0")`C). Cumulative winter
precipitation was
**`r stats$precip_stats[stats$precip_stats$location_id==51426 & stats$precip_stats$period=='All years',]$perc_hist_med`%**
of historical median on `r month.name[params$month]` 1. Cumulative
degree-days of freezing (CDDF) are
...
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09DD003",]$description,
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="White",]$description,
...
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09CB001",]$description,
" average"), textColour(stats$flow_stats[stats$flow_stats$location_id=="09CB001",]$description))` 
(Figure`r knitr::asis_output("\U00A0")`E1). In this
watershed, high flows are dominated by mountain snowmelt and glacial
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Lower_Yukon",]$description,
...
`r ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==10194 & stats$precip_stats$period=='All years',]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==10194 & stats$precip_stats$period=='All years',]$description))` from October through `r month.name[params$month-1]`
(Figure`r knitr::asis_output("\U00A0")`C). Cumulative winter
precipitation was
**`r stats$precip_stats[stats$precip_stats$location_id==10194 & stats$precip_stats$period=='All years',]$perc_hist_med`%**
of historical median on `r month.name[params$month]` 1. Cumulative
degree-days of freezing (CDDF) are
...
The estimated Yukon River discharge at the White River is currently
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09CD001",]$description,
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Porcupine",]$description,
...
`r ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==26894 & stats$precip_stats$period=='All years',]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==26894 & stats$precip_stats$period=='All years',]$description))` from October through `r month.name[params$month-1]`
(Figure`r knitr::asis_output("\U00A0")`C). Cumulative winter
precipitation was
**`r stats$precip_stats[stats$precip_stats$location_id==26894 & stats$precip_stats$period=='All years',]$perc_hist_med`%**
of historical median on `r month.name[params$month]` 1. Cumulative
degree-days of freezing (CDDF) are
...
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="09FD002",]$description,
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Peel",]$description,
...
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="10MA001",]$description,
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Liard",]$description,
...
`r ftext(paste0(stats$precip_stats[stats$precip_stats$location_id==32293 & stats$precip_stats$period=='All years',]$description, " normal"), textColour(stats$precip_stats[stats$precip_stats$location_id==32293 & stats$precip_stats$period=='All years',]$description))` from October through `r month.name[params$month-1]`
(Figure`r knitr::asis_output("\U00A0")`C). Cumulative winter
precipitation was
**`r stats$precip_stats[stats$precip_stats$location_id==32293 & stats$precip_stats$period=='All years',]$perc_hist_med`%**
of historical median on `r month.name[params$month]` 1. Cumulative
degree-days of freezing (CDDF) are
...
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="10AA001",]$description,
...
`r ftext(paste0(stats$basin_stats[stats$basin_stats$basin=="Alsek",]$description,
...
`r ftext(paste0(stats$flow_stats[stats$flow_stats$location_id=="08AB001",]$description,
...
flextable::as_grouped_data(tabl, groups = "sub_basin") %>% 
  ...
  flextable::width(j="Number", width=1.1) %>%
  flextable::width(j=3, width=0.8) %>%
  flextable::width(j="Date of Survey", width=1.1) %>%
  flextable::width(j=c(5,6,7), width = 0.7) %>%
  flextable::width(j=8, width=0.8) %>%
  flextable::width(j=9, width=0.6) %>%
