...
snowbullpillow <- function(location, custom_title, year, number="") {
...
snowbullCDDF <- function(timeseries_id, custom_title, language) {
...
if (language == "french") {
  lines <- c("Valeur maximale observée", "Valeur minimale observée", "Valeur médiane observée", "Année actuelle", "Niveau d'inondation", "L'étendue moyenne des \nvaleurs observées", "L'étendue min - max des \nvaleurs observées")
...
# Plot D
  plot_d <- snowbullCDDF(timeseries_id = 484, custom_title = "Whitehorse", language = language)
...
# Plot SWE
if (language=="french") {
  snowbullpillow(location = station_id, custom_title = "A1: Équivalent en eau de neige - Tagish", year = params$year)
} else {
...
# Plot SWE
if (language=="french") {
  snowbullpillow(location = station_id, custom_title = "A2: Équivalent en eau de neige - Wolf Creek", year = params$year)
} else {
...
# Plot D
plot_d <- snowbullCDDF(timeseries_id = 532, custom_title = "Teslin", language = language)
```
...
# Plot D
plot_d <- snowbullCDDF(timeseries_id = 540, custom_title = "Carmacks", language = language)
```
...
# Create plot D
plot_d <- snowbullCDDF(timeseries_id = 500, custom_title = "Faro", language = language)
```
...
# Plot SWE
if (language == "french") {
  snowbullpillow(location = station_id, custom_title = "A: Équivalent en eau de neige à Twin Creeks", year = params$year)
} else {
...
# Create plot D
plot_d <- snowbullCDDF(timeseries_id = 548, custom_title = "Mayo", language = language)
```
...
# Plot SWE
if (language == "french") {
  snowbullpillow(location = station_id, custom_title = "A: Équivalent en eau de neige au lac Withers", year = params$year)
} else {
...
# Create plot D
plot_d <- snowbullCDDF(timeseries_id = 492, custom_title = "Dawson", language = language)
...
plot_d <- snowbullCDDF(timeseries_id = 556, custom_title = "Old Crow", language = language)
...
# Create plot D and associated stat
plot_d <- snowbullCDDF(timeseries_id = 508, custom_title = "Watson Lake", language = language)
```
...
# Plot SWE
if (language == "french") {
  snowbullpillow(location = station_id, custom_title = "A: Équivalent en eau de neige à la rivière Hyland", year = params$year)
} else {
