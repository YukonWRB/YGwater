...
#'
#' @param con A connection object as returned by a [DBI::dbConnect()] call or, in the context of this package, a [hydrometConnect()], or [RWISConnect()], or [snowConnect()] call.
