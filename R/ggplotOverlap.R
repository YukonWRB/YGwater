...
ggplotOverlap <- function(location,
                          parameter,
                          record_rate = NULL,
                          startDay = 1,
                          endDay = 365,
